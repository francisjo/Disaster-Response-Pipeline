...
def load_data(messages_filepath, categories_filepath):
    """
          Function: Load dataframe from filepaths
          Args:
...
def clean_data(df):
    """
      Function: Clean data included in the DataFrame and transform categories part
      Args:
...
def save_data(df, database_filename):
    """
       Function: Saves DataFrame (df) to database path
       Args:
       df (DataFrame)
